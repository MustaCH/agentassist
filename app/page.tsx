    ...
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <section className="relative md:px-6 md:py-8 overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="relative bg-neutral-900 h-[90vh] md:rounded-2xl flex flex-col justify-center overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col gap-1 text-3xl md:text-5xl font-bold ms-6 p-4">
              <h1>
      ...
      <section id="features" className="px-6 py-16">
        ...
        <section className="px-6 py-16">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-6">
              ...
              <span className="inline-block bg-blue-700  text-white text-sm px-4 py-2 rounded-full font-semibold shadow">✉️ Redact personalized messages</span>
        ...
        <section>
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Your partner on WhatsApp</h2>
