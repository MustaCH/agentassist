      ...
      <section id="features" className="px-6 py-16">
        ...
        <section>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <a href="" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" className="flex justify-center gap-6 mb-4">
              <svg className="hover:scale-110 transition duration-150 ease-in-out" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
            ...
            <p data-aos="fade-up" data-aos-duratiom="1000" data-aos-delay="400" className="text-black/70 text-lg">Our agent adjusts to your workflow, no adaptation process.</p>
          </div>
